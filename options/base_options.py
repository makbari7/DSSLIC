...
class BaseOptions():
    ...
    def initialize(self):            
        ...
        self.parser.add_argument('--ncf', type=int, default=64, help='# of compGenerator filters in the first conv layer')         
        self.parser.add_argument('--n_downsample_comp', type=int, default=3, help='number of downsampling layers in compG')
        ...
        self.parser.add_argument('--comp_type', type=str, default='compG', help='use *ds* or *compG* as the downsampled input to G')
        self.parser.add_argument('--no_seg', action='store_true', help='if specified, do *not* use seg map as input')
